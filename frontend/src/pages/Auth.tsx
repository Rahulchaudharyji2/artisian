...
export default function Auth() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                // Artisan Login check
                const response = await fetch('http://localhost:5000/api/artisans/login', {
                    method: 'POST',
                ...
                // Redirect to profile to see the new creation
                navigate('/profile');
            }
        } catch (err) {
    ...
    return (
        <div className="flex w-full h-screen bg-white">
            ...
            <div className="w-full lg:w-1/2 h-full flex items-center justify-center p-8 bg-stone-50 overflow-y-auto">
                <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-2xl border border-stone-100">
                            ...
                            {!isLogin && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pb-2">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-bold text-stone-700">Art/Craft <span className="text-stone-400 font-normal">(Optional)</span></label>
                                            <select
                                                value={art}
